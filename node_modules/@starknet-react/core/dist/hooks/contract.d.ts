 ...
 * ```
 */
export declare function useContract({ abi, address }: UseContractArgs): UseContractResult;
 ...
 * ```
 */
export declare function useContractFactory({ compiledContract, classHash, abi, account, }: UseContractFactoryProps): UseContractFactoryResult;

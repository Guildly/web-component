 ...
 * ```
 */
export declare function useStarkName({ address, contract }: StarkNameArgs): StarkNameResult;
 ...
 * ```
 */
export declare function useAddressFromStarkName({ name, contract, }: AddressFromStarkNameArgs): AddressFromStarkNameResult;
export declare function getStarknetIdContract(chainId: string): string;

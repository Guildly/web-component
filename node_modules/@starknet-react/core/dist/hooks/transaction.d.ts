 ...
 * }
 */
export declare function useTransaction({ hash }: UseTransactionArgs): UseTransactionResult;
 ...
 * ```
 */
export declare function useTransactions({ hashes }: UseTransactionsArgs): UseTransactionResult[];

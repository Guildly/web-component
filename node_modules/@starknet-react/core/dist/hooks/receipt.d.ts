 ...
 * ```
 */
export declare function useWaitForTransaction({ hash, watch, onAcceptedOnL1, onAcceptedOnL2, onNotReceived, onPending, onReceived, onRejected, }: UseWaitForTransactionArgs): UseWaitForTransactionResult;

...
export declare type UseBlockArgs = Partial<FetchBlockArgs> & {
 ...
 * ```
 */
export declare function useBlock({ refetchInterval, onSuccess, blockIdentifier, }?: UseBlockArgs): UseBlockResult;
/** Arguments for `useBlockNumber`. */
export declare type UseBlockNumberArgs = Partial<FetchBlockArgs> & {
    /** How often to refresh the data. */
    refetchInterval?: number | false;
    /** Callback fired every time a new block is fetched. */
 ...
 * ```
 */
export declare function useBlockNumber({ refetchInterval, onSuccess, }?: UseBlockNumberArgs): UseBlockNumberResult;

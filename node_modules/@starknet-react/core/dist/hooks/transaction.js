...
function useTransaction({ hash }) {
    ...
    const { data, error, isStale: isIdle, isLoading, isFetching, isSuccess, isError, isFetched, isFetchedAfterMount, isRefetching, refetch, status, } = (0, react_query_1.useQuery)(queryKey({ library, hash }), fetchTransaction({
        library,
        hash,
    }));
    return {
